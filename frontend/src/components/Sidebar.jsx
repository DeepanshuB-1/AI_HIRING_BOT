    ...
    <aside className="w-56 min-h-screen bg-sidebar flex flex-col flex-shrink-0">
      ...
      <div className="px-3 py-4 border-t border-indigo-800 space-y-2">
        <a href="/portal" target="_blank" rel="noopener noreferrer"
          className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-indigo-300 hover:bg-indigo-800 hover:text-white transition-colors">
